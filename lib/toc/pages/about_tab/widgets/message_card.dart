...
class _MessageCardState extends State<MessageCard> {
      ...
      child: Row(
        children: [
          Flexible(
            ...
            text: TextSpan(
              children: [
                textWidget(TocLocalizations.of(context)!.mStaticEarn + ' ',
                    FontWeight.w400),
                textWidget(
          ...
          Padding(
            ...
            child: TooltipWidget(
                message:
                    TocLocalizations.of(context)!.mKarmapointEnrollTooltipMsg),
          )
        ],
      ),
    );
  ...
  TextSpan textWidget(String message, FontWeight font,
      {Color color = TocModuleColors.greys87, double fontSize = 12}) {
    return TextSpan(
      text: message,
      style: TextStyle(
          color: color,
