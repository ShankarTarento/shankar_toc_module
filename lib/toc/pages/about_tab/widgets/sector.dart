...
class TocSectorSubsectorView extends StatefulWidget {
  final List<SectorDetails> sectorDetails;
  const TocSectorSubsectorView({super.key, required this.sectorDetails});

  @override
  State<TocSectorSubsectorView> createState() => _SectorSubsectorViewState();
}

class _SectorSubsectorViewState extends State<TocSectorSubsectorView> {
