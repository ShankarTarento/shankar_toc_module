(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    // alert(String(root.pipwerks.SCORM.isAvailable()));
    // var api = root.pipwerks.SCORM.API.getHandle();
    root.pipwerks.SCORM.data.set("Initialized", true);
    // alert(String(api));
  }
})(this, function () {
  ("use strict");
  ...
  pipwerks.SCORM.API.find = function (win) {
    ...
    if (API) {
      ...
      trace(
        traceMsgPrefix +
          ": Error finding API. Find attempts: " +
          findAttempts +
          ". Find attempt limit: " +
          findAttemptLimit
      );
