...
class CustomMaterialControl extends StatefulWidget {
  const CustomMaterialControl({
  ...
  State<StatefulWidget> createState() {
    return _CustomMaterialControlState();
  }
}

class _CustomMaterialControlState extends State<CustomMaterialControl>
