...
class LearnTab {
  ...
  static List<LearnTab> items({required BuildContext context}) => [
        LearnTab(
          title: TocLocalizations.of(context)!.mLearnTabOverview,
        ),
        LearnTab(
          title: TocLocalizations.of(context)!.mLearnCourseContent,
        ),
        LearnTab(
          title: TocLocalizations.of(context)!.mLearnCourseDiscussion,
        ),
      ];
  ...
  static List<LearnTab> blendedProgramItems({required BuildContext context}) =>
      [
        ...
        LearnTab(
          title: TocLocalizations.of(context)!.mLearnCourseSessions,
        ),
        LearnTab(
          title: TocLocalizations.of(context)!.mLearnCourseDiscussion,
        ),
