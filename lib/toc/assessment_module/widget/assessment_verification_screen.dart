...
class _AssessmentVerificationScreenState
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.bodyMedium!.copyWith(letterSpacing: 0.25.r),
                    ),
                    TextButton(
                      child: Text(
  ...
  void startTimer() {
    ...
    new Timer.periodic(oneSec, (Timer timer) async {
      if (!mounted) return;
  ...
  Future<void> _submitSurvey() async {
    if (widget.compatibilityLevel >=
      ...
      var response = widget.isFeatured
          ? await assessmentService.getPublicAssessmentCompletionStatus(
              widget.requestBody,
            )
          : await assessmentService.getAssessmentCompletionStatus(
              widget.requestBody,
            );
      Navigator.of(context).pop(true);
                ...
                children: [
                  SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      strokeWidth: 8,
                      backgroundColor: TocModuleColors.greys.withValues(
                        alpha: 0,
                      ),
