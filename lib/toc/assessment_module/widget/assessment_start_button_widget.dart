                              ...
                              builder: (context) => resourceInfo.artifactUrl != null &&
                                  ...
                                  : (questionSet.length > 0
                                      ? compatibilityLevel >=
                                          ...
                                          : AssessmentSection(course, identifier, microSurvey != null ? microSurvey : questionSet, markSurveyCompleted, batchId, assessmentInfo!.expectedDuration, isNewAssessment: resourceInfo.artifactUrl != null ? false : true, primaryCategory: assessmentInfo!.primaryCategory, objectType: assessmentInfo!.objectType, assessmentsInfo: assessmentInfo!.questions, updateContentProgress: parentAction, parentCourseId: parentCourseId, resourceInfo: resourceInfo, isFeatured: isFeatured, courseCategory: courseCategory, guestUserData: guestUserData, isPreRequisite: isPreRequisite, preEnrolmentAssessmentId: preEnrolmentAssessmentId, preRequisiteMimeType: preRequisiteMimeType)
                                      : ErrorPage()),
                            ));
                          }
